...
%  Construct a ROI rectangle for the input fingerprint image and return the segmented fingerprint,
...
%inner area
roiArea = im2double(roiArea) - im2double(roiBound); %NUMBER OF FUNCTION INPUT ARGUMENTS
